...
const HomePage = ({isKakaoMapLoaded}) => {
  ...
  const foodImages = Object.values(import.meta.glob('../../assets/images/sample/eating/*.jpg', {
    eager: true,
    import: 'default'
  }));
  const cafeImages = Object.values(import.meta.glob('../../assets/images/sample/drinking/*.jpg', {
    eager: true,
    import: 'default'
  }));
  const stayImages = Object.values(import.meta.glob('../../assets/images/sample/lodging/*.jpg', {
    eager: true,
    import: 'default'
  }));
  const expImages = Object.values(import.meta.glob('../../assets/images/sample/doing/*.jpg', {
    eager: true,
    import: 'default'
  }));
  const etcImages = Object.values(import.meta.glob('../../assets/images/sample/etc/*.jpg', {
    eager: true,
    import: 'default'
  }));
